    ...
    <Wrapper>
      <RowBetween>
        ...
        <AutoRow gap="6px" style={{ justifyContent: 'flex-end' }}>
          <StyledLink href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">V2 Analytics</StyledLink>
          <StyledLink href="https://docs.solidly.com/">Docs</StyledLink>
          <StyledLink href="https://solidly.com/swap">App</StyledLink>
        </AutoRow>
      </RowBetween>
    </Wrapper>
  )
